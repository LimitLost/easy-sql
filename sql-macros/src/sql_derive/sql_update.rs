...
pub fn sql_update_base(item_name:&syn::Ident,fields:&Punctuated<syn::Field, syn::Token![,]>, table:&TokenStream) -> proc_macro::TokenStream{
...
pub fn sql_update(item: proc_macro::TokenStream) -> anyhow::Result<proc_macro::TokenStream> {
    ...
    Ok(sql_update_base(&item_name, &fields, &table))
}
