    ...
    F: Fn(&mut QueryBuilder<'_, D>) -> anyhow::Result<()>,
{
    ...
    fn updates_sqlx(
        ...
        panic!(
            "This method is not generated by the sql! macro, since it shouldn't be used inside of query! macro update clause. Put insides of the sql! macro as the update clause instead."
        );
    }
}
